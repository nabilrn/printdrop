...
int main(void)
{
    ...
    PD_TEST_ASSERT(pd_relay_build_registration_url("https://relay.printdrop.app/",
                                                   output,
                                                   sizeof(output)) == PD_RELAY_ENDPOINT_OK);
    PD_TEST_ASSERT(strcmp(output, "https://relay.printdrop.app/v1/sessions") == 0);
    ...
    PD_TEST_ASSERT(pd_relay_build_registration_url("http://relay.printdrop.app",
                                                   output,
                                                   sizeof(output)) ==
                   PD_RELAY_ENDPOINT_INVALID_BASE_URL);
    PD_TEST_ASSERT(pd_relay_build_registration_url("https://relay.printdrop.app?x=1",
                                                   output,
                                                   sizeof(output)) ==
                   PD_RELAY_ENDPOINT_INVALID_BASE_URL);
    PD_TEST_ASSERT(pd_relay_build_receiver_wss_url("https://relay.printdrop.app",
